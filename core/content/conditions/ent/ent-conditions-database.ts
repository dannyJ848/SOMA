...
function ent(
  id: string, name: string, category: ENTConditionCategory,
  icdCode: string, description: string,
  clinicalFeatures: string[], diagnosticApproach: string[],
  treatment: string, complications: string[],
): ENTConditionEntry {
  return { id, name, category, description, clinicalFeatures, diagnosticApproach, treatment, complications, icdCode };
}
...
export const ENT_CONDITION_ENTRIES: Record<string, ENTConditionEntry> = {
  ...
  'acute-otitis-media': ent(
    'acute-otitis-media', 'Acute Otitis Media', 'otologic', 'H66.90',
  ...
  'chronic-otitis-media': ent(
    'chronic-otitis-media', 'Chronic Otitis Media', 'otologic', 'H66.3',
  ...
  'otitis-externa': ent(
    'otitis-externa', 'Otitis Externa', 'otologic', 'H60.9',
  ...
  'cholesteatoma': ent(
    'cholesteatoma', 'Cholesteatoma', 'otologic', 'H71.9',
  ...
  'conductive-hearing-loss': ent(
    'conductive-hearing-loss', 'Conductive Hearing Loss', 'otologic', 'H90.2',
  ...
  'sensorineural-hearing-loss': ent(
    'sensorineural-hearing-loss', 'Sensorineural Hearing Loss', 'otologic', 'H90.5',
  ...
  'bppv': ent(
    'bppv', 'Benign Paroxysmal Positional Vertigo (BPPV)', 'vestibular', 'H81.1',
  ...
  'meniere-disease': ent(
    'meniere-disease', 'Meniere Disease', 'vestibular', 'H81.0',
  ...
  'vestibular-neuritis': ent(
    'vestibular-neuritis', 'Vestibular Neuritis', 'vestibular', 'H81.2',
  ...
  'acute-sinusitis': ent(
    'acute-sinusitis', 'Acute Sinusitis', 'rhinologic', 'J01.9',
  ...
  'chronic-sinusitis': ent(
    'chronic-sinusitis', 'Chronic Rhinosinusitis', 'rhinologic', 'J32.9',
  ...
  'nasal-polyps': ent(
    'nasal-polyps', 'Nasal Polyps', 'rhinologic', 'J33.9',
  ...
  'epistaxis': ent(
    'epistaxis', 'Epistaxis', 'rhinologic', 'R04.0',
  ...
  'deviated-septum': ent(
    'deviated-septum', 'Deviated Nasal Septum', 'rhinologic', 'J34.2',
  ...
  'allergic-rhinitis': ent(
    'allergic-rhinitis', 'Allergic Rhinitis', 'rhinologic', 'J30.9',
  ...
  'acute-laryngitis': ent(
    'acute-laryngitis', 'Acute Laryngitis', 'laryngologic', 'J04.0',
  ...
  'vocal-cord-nodules': ent(
    'vocal-cord-nodules', 'Vocal Cord Nodules and Polyps', 'laryngologic', 'J38.1',
  ...
  'laryngeal-cancer': ent(
    'laryngeal-cancer', 'Laryngeal Cancer', 'head-neck-oncology', 'C32.9',
  ...
  'laryngopharyngeal-reflux': ent(
    'laryngopharyngeal-reflux', 'Laryngopharyngeal Reflux (LPR)', 'laryngologic', 'K21.0',
  ...
  'vocal-cord-paralysis': ent(
    'vocal-cord-paralysis', 'Vocal Cord Paralysis', 'laryngologic', 'J38.0',
  ...
  'nasopharyngeal-carcinoma': ent(
    'nasopharyngeal-carcinoma', 'Nasopharyngeal Carcinoma', 'head-neck-oncology', 'C11.9',
  ...
  'oral-leukoplakia': ent(
    'oral-leukoplakia', 'Oral Leukoplakia', 'head-neck-oncology', 'K13.21',
  ...
  'salivary-gland-tumors': ent(
    'salivary-gland-tumors', 'Salivary Gland Tumors', 'salivary', 'D11.9',
  ...
  'tonsillitis': ent(
    'tonsillitis', 'Tonsillitis', 'pediatric-ent', 'J03.9',
  ...
  'peritonsillar-abscess': ent(
    'peritonsillar-abscess', 'Peritonsillar Abscess (Quinsy)', 'pediatric-ent', 'J36',
  ...
  'epiglottitis': ent(
    'epiglottitis', 'Epiglottitis', 'pediatric-ent', 'J05.1',
  ...
  'foreign-body-ear': ent(
    'foreign-body-ear', 'Foreign Body — Ear', 'pediatric-ent', 'T16',
  ...
  'foreign-body-nose': ent(
    'foreign-body-nose', 'Foreign Body — Nose', 'pediatric-ent', 'T17.1',
  ...
  'foreign-body-throat': ent(
    'foreign-body-throat', 'Foreign Body — Throat/Aerodigestive', 'pediatric-ent', 'T17.2',
  ...
  'obstructive-sleep-apnea': ent(
    'obstructive-sleep-apnea', 'Obstructive Sleep Apnea', 'laryngologic', 'G47.33',
  ...
  'temporomandibular-disorder': ent(
    'temporomandibular-disorder', 'Temporomandibular Disorder (TMD)', 'otologic', 'M26.60',
  ...
  'bells-palsy': ent(
    'bells-palsy', 'Bell\'s Palsy', 'otologic', 'G51.0',
  ...
  'acoustic-neuroma': ent(
    'acoustic-neuroma', 'Acoustic Neuroma (Vestibular Schwannoma)', 'otologic', 'D33.3',
  ...
  'thyroglossal-duct-cyst': ent(
    'thyroglossal-duct-cyst', 'Thyroglossal Duct Cyst', 'congenital', 'Q89.2',
  ...
  'branchial-cleft-cyst': ent(
    'branchial-cleft-cyst', 'Branchial Cleft Cyst', 'congenital', 'Q18.0',
  ...
  'otosclerosis': ent(
    'otosclerosis', 'Otosclerosis', 'otologic', 'H80.9',
  ...
  'sudden-sensorineural-hearing-loss': ent(
    'sudden-sensorineural-hearing-loss', 'Sudden Sensorineural Hearing Loss', 'otologic', 'H91.2',
  ...
  'croup': ent(
    'croup', 'Croup (Laryngotracheobronchitis)', 'pediatric-ent', 'J05.0',
  ...
  'periauricular-sinus': ent(
    'periauricular-sinus', 'Preauricular Sinus (Pit)', 'congenital', 'Q18.1',
  ...
  'subglottic-stenosis': ent(
    'subglottic-stenosis', 'Subglottic Stenosis', 'laryngologic', 'J38.6',
