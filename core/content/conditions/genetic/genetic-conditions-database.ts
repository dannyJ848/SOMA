...
function gc(
  id: string, name: string, category: GeneticConditionCategory,
  ...
  return {
    id, name, category, inheritance, geneOrChromosome, description,
...
export const GENETIC_CONDITION_ENTRIES: Record<string, GeneticConditionEntry> = {
  ...
  'down-syndrome': gc(
    'down-syndrome', 'Down Syndrome (Trisomy 21)', 'chromosomal',
  ...
  'turner-syndrome': gc(
    'turner-syndrome', 'Turner Syndrome (45,X)', 'chromosomal',
  ...
  'klinefelter-syndrome': gc(
    'klinefelter-syndrome', 'Klinefelter Syndrome (47,XXY)', 'chromosomal',
  ...
  'patau-syndrome': gc(
    'patau-syndrome', 'Patau Syndrome (Trisomy 13)', 'chromosomal',
  ...
  'marfan-syndrome': gc(
    'marfan-syndrome', 'Marfan Syndrome', 'autosomal-dominant',
  ...
  'ehlers-danlos-syndrome': gc(
    'ehlers-danlos-syndrome', 'Ehlers-Danlos Syndrome', 'autosomal-dominant',
  ...
  'neurofibromatosis-1': gc(
    'neurofibromatosis-1', 'Neurofibromatosis Type 1 (NF1)', 'autosomal-dominant',
  ...
  'neurofibromatosis-2': gc(
    'neurofibromatosis-2', 'Neurofibromatosis Type 2 (NF2)', 'autosomal-dominant',
    'Autosomal dominant; ~50% de novo mutations',
  ...
  'tuberous-sclerosis': gc(
    'tuberous-sclerosis', 'Tuberous Sclerosis Complex (TSC)', 'autosomal-dominant',
  ...
  'familial-hypercholesterolemia': gc(
    'familial-hypercholesterolemia', 'Familial Hypercholesterolemia (FH)', 'autosomal-dominant',
  ...
  'huntington-disease': gc(
    'huntington-disease', 'Huntington Disease', 'trinucleotide-repeat',
  ...
  'cystic-fibrosis': gc(
    'cystic-fibrosis', 'Cystic Fibrosis', 'autosomal-recessive',
  ...
  'sickle-cell-disease': gc(
    'sickle-cell-disease', 'Sickle Cell Disease', 'autosomal-recessive',
  ...
  'phenylketonuria': gc(
    'phenylketonuria', 'Phenylketonuria (PKU)', 'metabolic',
    'Autosomal recessive',
  ...
  'tay-sachs-disease': gc(
    'tay-sachs-disease', 'Tay-Sachs Disease', 'lysosomal-storage',
  ...
  'gaucher-disease': gc(
    'gaucher-disease', 'Gaucher Disease', 'lysosomal-storage',
  ...
  'fabry-disease': gc(
    'fabry-disease', 'Fabry Disease', 'lysosomal-storage',
  ...
  'alpha-1-antitrypsin-deficiency': gc(
    'alpha-1-antitrypsin-deficiency', 'Alpha-1 Antitrypsin Deficiency', 'autosomal-recessive',
  ...
  'wilson-disease': gc(
    'wilson-disease', 'Wilson Disease', 'autosomal-recessive',
  ...
  'hemochromatosis': gc(
    'hemochromatosis', 'Hereditary Hemochromatosis', 'autosomal-recessive',
  ...
  'duchenne-muscular-dystrophy': gc(
    'duchenne-muscular-dystrophy', 'Duchenne Muscular Dystrophy', 'x-linked',
  ...
  'becker-muscular-dystrophy': gc(
    'becker-muscular-dystrophy', 'Becker Muscular Dystrophy', 'x-linked',
  ...
  'hemophilia-a': gc(
    'hemophilia-a', 'Hemophilia A', 'x-linked',
  ...
  'hemophilia-b': gc(
    'hemophilia-b', 'Hemophilia B (Christmas Disease)', 'x-linked',
  ...
  'fragile-x-syndrome': gc(
    'fragile-x-syndrome', 'Fragile X Syndrome', 'trinucleotide-repeat',
  ...
  'williams-syndrome': gc(
    'williams-syndrome', 'Williams Syndrome', 'autosomal-dominant',
  ...
  'prader-willi-syndrome': gc(
    'prader-willi-syndrome', 'Prader-Willi Syndrome', 'chromosomal',
  ...
  'angelman-syndrome': gc(
    'angelman-syndrome', 'Angelman Syndrome', 'chromosomal',
  ...
  'von-willebrand-disease': gc(
    'von-willebrand-disease', 'Von Willebrand Disease', 'autosomal-dominant',
  ...
  'brca-hereditary-breast-ovarian': gc(
    'brca-hereditary-breast-ovarian', 'BRCA-Related Hereditary Breast & Ovarian Cancer', 'hereditary-cancer',
  ...
  'lynch-syndrome': gc(
    'lynch-syndrome', 'Lynch Syndrome (HNPCC)', 'hereditary-cancer',
  ...
  'li-fraumeni-syndrome': gc(
    'li-fraumeni-syndrome', 'Li-Fraumeni Syndrome', 'hereditary-cancer',
