...
function oph(
  ...
  return { id, name, nameEs, category, icdCode, description, clinicalFindings, diagnosticApproach, treatment, prognosis };
}
...
export const OPHTHALMOLOGY_CONDITION_ENTRIES: Record<string, OphthalmologyConditionEntry> = {
  ...
  'corneal-ulcer': oph(
    'corneal-ulcer', 'Corneal Ulcer (Microbial Keratitis)', 'Úlcera Corneal (Queratitis Microbiana)',
  ...
  'keratoconus': oph(
    'keratoconus', 'Keratoconus', 'Queratocono',
  ...
  'blepharitis': oph(
    'blepharitis', 'Blepharitis', 'Blefaritis',
    'oculoplastics', 'H01.0',
  ...
  'chalazion-hordeolum': oph(
    'chalazion-hordeolum', 'Chalazion / Hordeolum (Stye)', 'Chalazión / Orzuelo',
    'oculoplastics', 'H00',
  ...
  'dry-eye-disease': oph(
    'dry-eye-disease', 'Dry Eye Disease', 'Síndrome del Ojo Seco',
  ...
  'open-angle-glaucoma': oph(
    'open-angle-glaucoma', 'Primary Open-Angle Glaucoma (POAG)', 'Glaucoma Primario de Ángulo Abierto (GPAA)',
    'glaucoma', 'H40.1',
  ...
  'angle-closure-glaucoma': oph(
    'angle-closure-glaucoma', 'Acute Angle-Closure Glaucoma', 'Glaucoma Agudo de Ángulo Cerrado',
    'glaucoma', 'H40.2',
  ...
  'glaucoma-suspect': oph(
    'glaucoma-suspect', 'Glaucoma Suspect / Ocular Hypertension', 'Sospecha de Glaucoma / Hipertensión Ocular',
    'glaucoma', 'H40.0',
  ...
  'dry-amd': oph(
    'dry-amd', 'Dry Age-Related Macular Degeneration (Dry AMD)', 'Degeneración Macular Seca Relacionada con la Edad',
  ...
  'wet-amd': oph(
    'wet-amd', 'Wet (Neovascular) Age-Related Macular Degeneration', 'Degeneración Macular Húmeda (Neovascular) Relacionada con la Edad',
  ...
  'diabetic-retinopathy': oph(
    'diabetic-retinopathy', 'Diabetic Retinopathy', 'Retinopatía Diabética',
  ...
  'retinal-detachment': oph(
    'retinal-detachment', 'Retinal Detachment', 'Desprendimiento de Retina',
  ...
  'central-retinal-artery-occlusion': oph(
    'central-retinal-artery-occlusion', 'Central Retinal Artery Occlusion (CRAO)', 'Oclusión de la Arteria Central de la Retina (OACR)',
  ...
  'central-retinal-vein-occlusion': oph(
    'central-retinal-vein-occlusion', 'Central Retinal Vein Occlusion (CRVO)', 'Oclusión de la Vena Central de la Retina (OVCR)',
  ...
  'vitreous-hemorrhage': oph(
    'vitreous-hemorrhage', 'Vitreous Hemorrhage', 'Hemorragia Vítrea',
  ...
  'optic-neuritis': oph(
    'optic-neuritis', 'Optic Neuritis', 'Neuritis Óptica',
  ...
  'papilledema': oph(
    'papilledema', 'Papilledema', 'Papiledema',
  ...
  'cranial-nerve-palsy': oph(
    'cranial-nerve-palsy', 'Cranial Nerve III, IV, VI Palsy', 'Parálisis de Nervios Craneales III, IV, VI',
  ...
  'conjunctivitis-bacterial': oph(
    'conjunctivitis-bacterial', 'Bacterial Conjunctivitis', 'Conjuntivitis Bacteriana',
    'infectious', 'H10.0',
  ...
  'conjunctivitis-viral': oph(
    'conjunctivitis-viral', 'Viral Conjunctivitis (Epidemic Keratoconjunctivitis)', 'Conjuntivitis Viral (Queratoconjuntivitis Epidémica)',
    'infectious', 'H10.1',
  ...
  'uveitis': oph(
    'uveitis', 'Uveitis (Anterior / Intermediate / Posterior / Panuveitis)', 'Uveítis (Anterior / Intermedia / Posterior / Panuveítis)',
    'infectious', 'H20',
  ...
  'orbital-cellulitis': oph(
    'orbital-cellulitis', 'Orbital Cellulitis', 'Celulitis Orbitaria',
    'infectious', 'H05.01',
  ...
  'endophthalmitis': oph(
    'endophthalmitis', 'Endophthalmitis', 'Endoftalmitis',
    'infectious', 'H44.0',
  ...
  'amblyopia': oph(
    'amblyopia', 'Amblyopia (Lazy Eye)', 'Ambliopía (Ojo Vago)',
    'pediatric-eye', 'H53.0',
  ...
  'strabismus': oph(
    'strabismus', 'Strabismus (Squint / Ocular Misalignment)', 'Estrabismo',
    'pediatric-eye', 'H50',
  ...
  'retinopathy-of-prematurity': oph(
    'retinopathy-of-prematurity', 'Retinopathy of Prematurity (ROP)', 'Retinopatía del Prematuro (ROP)',
    'pediatric-eye', 'H35.1',
  ...
  'open-globe-injury': oph(
    'open-globe-injury', 'Open Globe Injury', 'Traumatismo Ocular Abierto',
    'trauma', 'S05.6',
  ...
  'chemical-burn-eye': oph(
    'chemical-burn-eye', 'Chemical Burn (Ocular)', 'Quemadura Química Ocular',
    'trauma', 'T26.6',
  ...
  'thyroid-eye-disease': oph(
    'thyroid-eye-disease', 'Thyroid Eye Disease (Graves Ophthalmopathy)', 'Enfermedad Ocular Tiroidea (Oftalmopatía de Graves)',
    'oculoplastics', 'H06.2',
  ...
  'dacryocystitis': oph(
    'dacryocystitis', 'Dacryocystitis', 'Dacriocistitis',
    'oculoplastics', 'H04.3',
  ...
  'ocular-melanoma': oph(
    'ocular-melanoma', 'Uveal Melanoma (Choroidal / Ciliary Body / Iris)', 'Melanoma Uveal (Coroideo / Cuerpo Ciliar / Iris)',
    'oncologic', 'C69.3',
  ...
  'herpes-simplex-keratitis': oph(
    'herpes-simplex-keratitis', 'Herpes Simplex Keratitis', 'Queratitis por Herpes Simple',
    'infectious', 'H19.1',
  ...
  'central-serous-chorioretinopathy': oph(
    'central-serous-chorioretinopathy', 'Central Serous Chorioretinopathy (CSC)', 'Coriorretinopatía Serosa Central (CSC)',
  ...
  'retinitis-pigmentosa': oph(
    'retinitis-pigmentosa', 'Retinitis Pigmentosa (RP)', 'Retinitis Pigmentosa (RP)',
