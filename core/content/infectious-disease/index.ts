...
// Common Infectious Disease Conditions (Spanish-First Bilingual Content)
export { sepsisSepticemia } from './sepsis-septicemia';
export { neumoniaPneumonia } from './neumonia-pneumonia';
export { infeccionUrinariaUti } from './infeccion-urinaria-uti';
export { tuberculosisTb } from './tuberculosis-tb';
...
export const infectiousDiseaseContent = {
  ...
  categories: [
    ...
    {
      id: 'common-conditions-bilingual',
      name: 'Common Conditions (Spanish-First Bilingual)',
      nameEs: 'Condiciones Comunes (Bilingue Espanol-Primero)',
      topics: [
        { id: 'sepsis-septicemia', name: 'Sepsis / Septicemia', nameEs: 'Sepsis / Septicemia' },
        { id: 'neumonia-pneumonia', name: 'Pneumonia', nameEs: 'Neumonia' },
        { id: 'infeccion-urinaria-uti', name: 'Urinary Tract Infection (UTI)', nameEs: 'Infeccion del Tracto Urinario (ITU)' },
        { id: 'tuberculosis-tb', name: 'Tuberculosis (TB)', nameEs: 'Tuberculosis (TB)' },
      ],
    },
  ],
