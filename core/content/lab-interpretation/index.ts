 ...
 *
 * Spanish-first bilingual educational content (EducationalContent type):
 * - Hemograma Completo (CBC)
 * - Panel Metabolico Completo (CMP)
 * - Perfil Lipidico (Lipid Panel)
 * - Pruebas Hepaticas (Liver Function Tests)
 * - Panel Tiroideo (Thyroid Panel)
 */
...
// Spanish-first bilingual educational content (EducationalContent type)
export { hemogramaCompletoCBC } from './hemograma-completo-cbc';
export { panelMetabolicoCompletoCMP } from './panel-metabolico-completo-cmp';
export { perfilLipidicoLipidPanel } from './perfil-lipidico-lipid-panel';
export { pruebasHepaticasLiverFunction } from './pruebas-hepaticas-liver-function';
export { panelTiroideoThyroidPanel } from './panel-tiroideo-thyroid-panel';
