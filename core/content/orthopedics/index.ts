 ...
 * - Conditions (bilingual Spanish-first: fractures, osteoarthritis, herniated disc, ligament injuries)
 *
...
// Conditions exports (bilingual Spanish-first)
export { fracturasContent } from './conditions/fracturas-fractures';
export { artritisDegenerativaContent } from './conditions/artritis-degenerativa-osteoarthritis';
export { herniaDiscalContent } from './conditions/hernia-discal-herniated-disc';
export { lesionesLigamentosContent } from './conditions/lesiones-ligamentos-ligament-injuries';
...
export const getAllOrthopedicsPatientContent = async () => {
  const modules = await Promise.all([
    ...
    // Conditions (bilingual Spanish-first)
    import('./conditions/fracturas-fractures'),
    import('./conditions/artritis-degenerativa-osteoarthritis'),
    import('./conditions/hernia-discal-herniated-disc'),
    import('./conditions/lesiones-ligamentos-ligament-injuries'),
  ]);
