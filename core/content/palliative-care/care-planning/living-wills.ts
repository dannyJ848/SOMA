...
- A living will is different from a regular will about money and belongings`,
      keyTerms: [
        ...
        { term: 'advance directive', definition: 'A legal document that tells others your wishes about medical care if you cannot speak for yourself' },
      ],
      analogies: [
