...
export * from './mood-disorders/depresion-depression';
...
export * from './anxiety-disorders/ansiedad-generalizada-gad';
...
export * from './trauma-disorders/trastorno-estres-postraumatico-ptsd';
...
export * from './eating-disorders/trastornos-alimentarios-eating-disorders';
