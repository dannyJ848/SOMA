    ...
    chiefComplaints: [
      {
        ...
        differentialDiagnoses: ['Olecranon bursitis', 'Radial tunnel syndrome'],
    ...
    chiefComplaints: [
      {
        ...
        differentialDiagnoses: ['Fracture', 'Sprain', 'Arthritis'],
    ...
    chiefComplaints: [
      {
        ...
        differentialDiagnoses: ['Muscle strain', 'Tear', 'Referred back pain'],
    ...
    chiefComplaints: [
      {
        ...
        differentialDiagnoses: ['Stress fracture', 'Compartment syndrome', 'Achilles pathology'],
