...
export const REGION_STRUCTURES: AnatomicalStructure[] = [
  // Head region - slightly taller than wide for realistic proportions
  {
    id: 'head',
    name: 'Head',
    latinName: 'Caput',
    ...
    position: [0, 1.38, 0],
    scale: [0.82, 1.0, 0.85],
    geometryArgs: [0.22, 24, 24],
    color: '#e0c8b8',
    visibility: { structureId: 'head', minDetailLevel: 'body' },
    clickable: true,
  },
  // Neck - tapered cylinder, narrower at top
  {
    id: 'neck',
    name: 'Neck',
    latinName: 'Collum',
    ...
    position: [0, 1.08, 0],
    scale: [1, 1, 0.9],
    geometryArgs: [0.07, 0.09, 0.18, 12],
    color: '#e0c8b8',
    visibility: { structureId: 'neck', minDetailLevel: 'body' },
    clickable: true,
  },
  // Chest/Thorax - wider capsule, flattened front-to-back
  {
    id: 'chest',
    name: 'Chest',
    latinName: 'Thorax',
    ...
    position: [0, 0.6, 0],
    scale: [1.0, 1.0, 0.7],
    geometryArgs: [0.28, 0.32, 12, 20],
    color: '#e8d4c8',
    visibility: { structureId: 'chest', minDetailLevel: 'body' },
    clickable: true,
  },
  // Abdomen - slightly narrower than chest
  {
    id: 'abdomen',
    name: 'Abdomen',
    latinName: 'Abdomen',
    ...
    position: [0, 0.05, 0],
    scale: [1.0, 1.0, 0.65],
    geometryArgs: [0.26, 0.28, 12, 20],
    color: '#e8d4c8',
    visibility: { structureId: 'abdomen', minDetailLevel: 'body' },
    clickable: true,
  },
  // Pelvis region - wider, shorter capsule
  {
    id: 'pelvisRegion',
    name: 'Pelvis',
    latinName: 'Pelvis',
    ...
    position: [0, -0.32, 0],
    scale: [1.1, 0.7, 0.7],
    geometryArgs: [0.22, 0.12, 12, 16],
    color: '#e0c8b8',
    visibility: { structureId: 'pelvisRegion', minDetailLevel: 'body' },
    clickable: true,
  },
  // Arms - capsule segments for upper arm
  {
    id: 'leftArm',
    name: 'Left Arm',
  ...
  // Legs - capsule segments for upper leg
  {
    id: 'leftLeg',
    name: 'Left Leg',
...
export const SYSTEM_COLORS: Record<AnatomicalSystem, string> = {
  integumentary: '#e8c4a8',
  muscular: '#cc4444',
  skeletal: '#e8e8c8',
  cardiovascular: '#e01030',
  respiratory: '#4a9ade',
  digestive: '#d4943a',
  nervous: '#f0d050',
  urinary: '#8b6fcf',
