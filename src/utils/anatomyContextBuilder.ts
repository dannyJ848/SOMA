...
const STRUCTURE_DATA: Record<string, StructureEducationalContent> = {
  ...
  'hand-left': {
    ...
    commonConditions: ['Trigger finger', 'Arthritis', 'De Quervain\'s', 'Carpal tunnel syndrome'],
  ...
  'elbow-left': {
    ...
    commonConditions: ['Tennis elbow (lateral epicondylitis)', 'Golfer\'s elbow (medial epicondylitis)', 'Bursitis', 'Arthritis'],
  ...
  'wrist-left': {
    ...
    commonConditions: ['Carpal tunnel syndrome', 'Sprain', 'Arthritis', 'Fracture', 'De Quervain\'s'],
